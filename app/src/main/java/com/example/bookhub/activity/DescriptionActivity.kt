...
import com.example.bookhub.database.BooksDatabase
import com.example.bookhub.util.ConnectionManager
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.activity_description.*
//import com.varun.bookhub.R
import org.json.JSONObject
...
class DescriptionActivity : AppCompatActivity() {
            ...
            val jsonRequest = object:JsonObjectRequest(Request.Method.POST,url,jsonParams,Response.Listener{
                ...
                try{
                    ...
                    if(success){
                        ...
                        Picasso.get().load(bookJsonObject.getString("image")).error(R.drawable.adventures_finn).into(imgBookImage)
                        txtBookName.text = bookJsonObject.getString("name")
                        txtBookAuthor.text = bookJsonObject.getString("author")
                        txtBookPrice.text = bookJsonObject.getString("price")
                        txtBookRating.text = bookJsonObject.getString("rating")
    ...
    class DBAsyncTask(val context: Context, val bookEntity: BookEntity, val mode: Int) : AsyncTask<Void, Void, Boolean>(){
        ...
        val db = Room.databaseBuilder(context, BooksDatabase::class.java, "books-db").build()
